# CLAUDE.md - project-title-international-license-management-s

This file provides guidance to Claude Code (claude.ai/code) when working with this project.

## Project Overview

**Name**: project-title-international-license-management-s
**Description**: A modern React application
**Author**: Unosquare
**Created**: 2025-12-04T20:03:03.314Z
...
```
project-title-international-license-management-s/
├── src/
